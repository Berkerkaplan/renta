...
import 'package:renta/main_screens/payment_info_screen.dart';
...
class _AddressSelectionScreenState extends State<AddressSelectionScreen> {
  List<Address> savedAddresses = [
    Address(
        name: "Benim ev",
        details: "MERKEZ - Edirne / Türkiye İstasyon mah nane sok daire:5"),
  ];

  List<Address> billingAddresses = [
    Address(
        name: "Benim ev fatura",
        details: "Edirne / Türkiye İstasyon mah nane sok daire:5"),
  ];
          ...
          children: [
            ...
            Padding(
              ...
              child: TextButton.icon(
                onPressed: () {}, // Yeni kayıtlı adres ekleme işlevi
                icon: Icon(Icons.add, color: Colors.orange),
                label: Text(
                    'Yeni Ekle', style: TextStyle(color: Colors.orange)),
              ),
            ),
            Divider(),
            Padding(
            ...
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 16, vertical: 8),
              child: TextButton.icon(
                onPressed: () {}, // Yeni fatura adresi ekleme işlevi
                icon: Icon(Icons.add, color: Colors.orange),
                label: Text(
                    'Yeni Ekle', style: TextStyle(color: Colors.orange)),
              ),
